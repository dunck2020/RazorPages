    ...
    public partial class ClientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2021, 10, 31, 13, 55, 25, 452, DateTimeKind.Local).AddTicks(4033), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2021, 10, 31, 13, 55, 25, 461, DateTimeKind.Local).AddTicks(5190), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2021, 10, 31, 13, 55, 25, 461, DateTimeKind.Local).AddTicks(5112), 7 });
